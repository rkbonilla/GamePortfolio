...
function animate() {
    ...
    //Adding player1 and player2 scores.
    context.save();
    ...
    context.drawImage(img, ball.x - 35, ball.y - 35, ball.width + 25, ball.height + 25);
    player1.drawRect();
    player2.drawRect();
}
